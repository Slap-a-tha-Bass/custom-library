...
const useTheme = () => {
  ...
  const toggleRedTheme = (e: any) =>
    setTheme((prevTheme: string) =>
      prevTheme === "dark" || "light" ? "red" : "dark"
    );
  const togglePurpleTheme = (e: any) =>
    setTheme((prevTheme: string) =>
      prevTheme === "dark" || "light" ? "purple" : "dark"
    );
  const toggleBlueTheme = (e: any) =>
    setTheme((prevTheme: string) =>
      prevTheme === "dark" || "light" ? "blue" : "dark"
    );
  const toggleOrangeTheme = (e: any) =>
    setTheme((prevTheme: string) =>
      prevTheme === "dark" || "light" ? "orange" : "dark"
    );
  useEffect(() => {
